...
public class ECommerceTC3 extends BaseTest {
    ...
    public void FillForm() throws InterruptedException
    {
        ...
        driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector()).scrollIntoView(text(\"Denmark\"))"));
        driver.findElement(By.xpath("//android.widget.TextView[@text='Denmark']")).click();
